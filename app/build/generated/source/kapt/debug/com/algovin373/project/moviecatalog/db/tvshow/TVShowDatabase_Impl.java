...
public final class TVShowDatabase_Impl extends TVShowDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsTVShowEntity.put("idTVShow", new TableInfo.Column("idTVShow", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTVShowEntity.put("posterTVShow", new TableInfo.Column("posterTVShow", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTVShowEntity.put("titleTVShow", new TableInfo.Column("titleTVShow", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsTVShowEntity.put("releaseDateTVShow", new TableInfo.Column("releaseDateTVShow", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoTVShowEntity.equals(_existingTVShowEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "TVShowEntity(com.algovin373.project.moviecatalog.db.tvshow.TVShowEntity).\n"
                  + " Expected:\n" + _infoTVShowEntity + "\n"
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "TVShowEntity");
  }
