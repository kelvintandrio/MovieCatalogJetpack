  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsMovieEntity.put("idMovie", new TableInfo.Column("idMovie", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMovieEntity.put("posterMovie", new TableInfo.Column("posterMovie", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMovieEntity.put("titleMovie", new TableInfo.Column("titleMovie", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMovieEntity.put("releaseDateMovie", new TableInfo.Column("releaseDateMovie", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoMovieEntity.equals(_existingMovieEntity)) {
          return new RoomOpenHelper.ValidationResult(false, "MovieEntity(com.algovin373.project.moviecatalog.db.movie.MovieEntity).\n"
                  + " Expected:\n" + _infoMovieEntity + "\n"
